...
# Parts
capa_dura_removivel = Part.create(name: 'Capa dura removível', description: 'Capa removível chamada de Jacket, capa dura é bem simples, não tem muitas coisas na parte frontal', supplier: cores_vivas, price: '20')
capa_curstom_padrao = Part.create(name: 'Capa curstom padrao', description: 'Ela contém as informações, ilustrações e todas as outras coisas impressas diretamente na capa.', supplier: cores_vivas, price: '25')
capa_de_brochura = Part.create(name: 'Capa brochura', description: 'Ela contém as informações, ilustrações e todas as outras coisas impressas diretamente na capa.', supplier: soft, price: '25')
capa_de_bolso = Part.create(name: 'Capa de Bolso', description: 'As capas duras são feitas de materiais rígidos, como papelão revestido ou pano, que oferecem proteção adicional ao livro.', supplier: am2, price: '25')
capa_de_tecido = Part.create(name: 'Capa de Tecido', description: 'São feitas de material de tecido resistente e podem ser decoradas com estampas, texturas ou detalhes em relevo.', supplier: cores_vivas, price: '25')
capa_relevo = Part.create(name: 'Capa com Relevo', description: 'As capas com relevo têm elementos texturizados ou em relevo na capa, criando uma sensação tátil interessante. Essas capas podem adicionar um toque de sofisticação ao design do livro.', supplier: am2, price: '30')
capa_de_po = Part.create(name: 'Capa de Pó', description: 'Capa de pó removível, que envolve o livro e geralmente contém informações adicionais sobre o livro, como resenhas, elogios do autor e sinopses.', supplier: am2, price: '25')
capa_transparente = Part.create(name: 'Capa Transparente', description: 'Capa transparente que protege a capa principal', supplier: papelaria_smart, price: '25')
capa_minimalista = Part.create(name: 'Capa Minimalista', description: 'capa com designs simples e limpos, muitas vezes usando cores sólidas e tipografia elegante', supplier: soft, price: '25')
papel_offset = Part.create(name: 'Papel Offset', description: 'É um papel de uso geral, frequentemente usado para impressão em escritórios', supplier: am2, price: '25')
papel_couche = Part.create(name: 'Papel Couché', description: 'Este papel é revestido com uma camada de revestimento brilhante ou fosco, o que o torna ideal para impressão de alta qualidade em cores', supplier: cores_vivas, price: '25')
papel_reciclado = Part.create(name: 'Papel Reciclado', description: 'Feito a partir de papel reciclado, este tipo de papel é ecologicamente correto e é usado para impressão de documentos que enfatizam a sustentabilidade.', supplier: am2, price: '25')
papel_vegetal = Part.create(name: 'Papel Vegetal', description: ' um papel translúcido e resistente, geralmente usado para desenho técnico, cópias de plantas de arquitetura e ilustrações técnicas.', supplier: papelaria_smart, price: '30')
papel_seda = Part.create(name: 'Papel de Seda', description: 'Um papel leve e delicado usado frequentemente para embrulhar presentes ou como papel de proteção em artigos frágeis.', supplier: soft, price: '30')
lombada = Part.create(name: 'Lombada', description: 'A lombada é a parte da capa que fica na espinha do livro e geralmente exibe o título do livro e o nome do autor.', supplier: am2, price: '30')
papel_com_marca = Part.create(name: "Papel com Marca-d'água", description: "marcas-d'água incorporadas no papel, que são visíveis quando a folha é mantida à luz.", supplier: am2, price: '30')
